...
static const int64_t nBlockRewardReserve = 2000000 * COIN; // premine 200,000,000 RBX
...
inline int64_t MasternodeCollateral(int nHeight) { return 250000; } // .25 Million RBX required as collateral
