...
/** RuBiX unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RuBiXUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RuBiXUnits(QObject *parent);
...
typedef RuBiXUnits::Unit RuBiXUnit;
