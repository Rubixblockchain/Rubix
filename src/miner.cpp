...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    CBlock *pblock = pblocktemplate.get();
        ...
        LogPrintf("Running RubixMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("RubixMiner terminated\n");
        throw;
    }
}
